...
<jsp:include page="../template/header.jsp">
	<jsp:param value="주문하기" name="pageTitle"/>
</jsp:include>
							...
							<c:forEach var="cJVO" items="${cjList }" varStatus="status">
								...
								<script type="text/javascript">
									...
									$(document).ready(function(){
										...
										// 할인 가격
										// 수정 2. 할인 가격을 100단위에서 10단위로 낮춤
										var discounted =  Math.round( (beforeoPrice * disrate) / 10) * 10;
										// 총 할인 가격
										total_discounted += discounted;
										$('#discounted').text(total_discounted.toLocaleString('en'));
						
										// 할인된 가격
										// 수정 3. 할인된 가격 10단위로 맞춤
										var afteroPrice = Math.round( (beforeoPrice-discounted) / 10 ) * 10;
										// 할인된 가격의 총합
